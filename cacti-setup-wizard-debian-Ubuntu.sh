...
echo "innodb_buffer_pool_size = 500M" >>  /etc/mysql/mariadb.conf.d/50-server.cnf
...
echo "collation_server  = utf8mb4_unicode_ci" >> /etc/mysql/mariadb.conf.d/50-server.cnf
